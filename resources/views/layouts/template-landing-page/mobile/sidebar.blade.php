            ...
            <ul class="submenu">
                <li class="has-children">
                    <div class="collapse-wrap">
                        <a href="javascript:void(0);" class="parent-link">Home<i data-feather="chevron-right"></i></a>
                    </div>
                    <ul>
                        <li>
                ...
                <li class="has-children">
                    <div class="collapse-wrap">
                        <a href="javascript:void(0);" class="parent-link">Blog<i data-feather="chevron-right"></i></a>
                    </div>
                    <ul>
                        <li>
                ...
                <li class="has-children">
                    <div class="collapse-wrap">
                        <a href="javascript:void(0);" class="parent-link">FAQ<i data-feather="chevron-right"></i></a>
                    </div>
                    <ul>
                        <li>
