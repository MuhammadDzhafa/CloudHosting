<header class="bg-white shadow-sm lg:w-fixed lg:h-auto lg:opacity-1"
    style="padding: 8px 120px; gap: 0px; border: 0px solid transparent; border-bottom: 1px solid var(--Base-0, #FFFFFF);">
    <div class="webapp-navbar w-full">
        <div class="webapp-navbar-inner flex items-center justify-between h-16">
            ...
            <div class="center-right flex items-center justify-end flex-grow">
                <div id="webapp-navbar-menu" class="flex items-center space-x-10 lg:space-x-12">
                    <a href="#"
                    ...
                    <div class="dropdown is-hoverable">
                        ...
                        <div class="dropdown-menu" id="dropdown-menu" role="menu">
                            <div class="dropdown-content">
                                ...
                                <a href="#" class="dropdown-item">Cloud Hosting</a>
                                <a href="#" class="dropdown-item">WordPress Hosting</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="#"
                        class="bg-[#4A6DCB] px-4 py-3 rounded-lg flex items-center justify-center lg:w-[15%] lg:h-[100%] md:w-[100%] md:h-[45px] hover:bg-[#3d5bb4] transition duration-150 ease-in-out whitespace-nowrap">
                        <span
                            class="lg:w-[86px] lg:h-[23px] md:w-[70px] md:h-[20px] font-inter lg:text-lg md:text-base font-medium leading-[23.2px] text-center text-[#F3F5FC]">Contact
                            Us</span>
                    </a>
                </div>
            </div>
