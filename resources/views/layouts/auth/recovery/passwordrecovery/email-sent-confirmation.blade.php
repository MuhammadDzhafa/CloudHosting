...
<head>
    ...
    <title>Awan Hosting :: Email Sent Confirmation</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
    <div class="bg-white p-6 sm:p-8 md:p-10 rounded-xl shadow-lg w-full max-w-[560px] border border-[#DEDEDE]">
        ...
        <div class="flex justify-center">
            <a
                href="{{ route('login') }}"
                class="w-full sm:w-[480px] text-[#F3F5FC] font-medium text-center py-3 sm:py-4 px-6 rounded-full inline-block transition duration-300 ease-in-out hover:opacity-90 transform active:scale-[0.98]"
