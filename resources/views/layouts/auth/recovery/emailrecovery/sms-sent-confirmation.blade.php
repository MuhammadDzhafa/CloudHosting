...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-6 md:p-10 rounded-[12px] shadow-lg max-w-[560px] w-full h-auto border border-[#DEDEDE]">
        <div class="flex justify-center mb-6">
            <img src="{{ asset('assets/img/illust.svg') }}" alt="Email sent illustration" class="w-full max-w-[350px] h-auto">
        </div>
        <h2 class="text-2xl md:text-3xl font-semibold text-center text-[#464646] mb-4" style="width: 100%; line-height: 1.2;">
            SMS has been sent!
        </h2>
        <p class="text-[#464646] text-center mb-6 text-base md:text-lg" style="width: 100%; line-height: 1.5;">
