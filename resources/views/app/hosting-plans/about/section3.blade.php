        ...
        <div class="card-container">
            <div class="card">
                <div class="card-content-product">
                    ...
                    <p class="content">Find and secure the perfect web address with our easy-to-use domain registration
                        platform.</p>
                </div>
            </div>
        </div>
        <div class="card-container">
            <div class="card">
                <div class="card-content-product">
                    ...
                    <p class="content">Unlock unparalleled flexibility and performance with our cutting-edge cloud
                        hosting solutions.</p>
                </div>
            </div>
        </div>
        <div class="card-container">
            <div class="card">
                <div class="card-content-product">
                    ...
                    <p class="content">Enhance your WordPress site with our optimized hosting services designed for
