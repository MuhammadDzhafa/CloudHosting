<div class="section-frame padding-6 bg-gradient-custom flex flex-col justify-center items-center h-[631px]">
    ...
    <div class="flex flex-col flex-grow gap-4 w-full">
        ...
        <div id="domain-container" class="flex justify-center items-stretch space-x-[10px] w-full mb-5">
            ...
            <div class="card-domain popular-domain w-[225.6px] p-[20px_0_0_0] rounded-[16px] border border-[#DEDEDE] bg-white shadow-[0_1px_3px_rgba(0,0,0,0.1)]" data-domain="{{ $domain }}">
