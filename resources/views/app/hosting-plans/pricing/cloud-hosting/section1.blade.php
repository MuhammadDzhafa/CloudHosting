<div class="flex flex-col md:flex-row bg-gradient-custom section-frame" style="padding: 100px 120px 0 120px;">
    ...
    <div class="md:w-1/2 h-[614px] bg-white text-gray-800 rounded-t-xl" style="padding: 30px 50px;">
        ...
        <div class="custom-col custom-col-2">
            ...
            <div class="custom-slider-section">
                ...
                <div class="flex items-center">
                    <div id="ram-value" class="custom-slider-value text-center" style="width: 75px;">4 GB</div>
                    <input id="ram-slider" type="range" min="0" max="4" step="1" value="0" class="custom-slider">
                </div>
            </div>
            ...
            <div class="custom-slider-section">
                ...
                <div class="flex items-center">
                    <div id="cpu-value" class="custom-slider-value text-center" style="width: 75px;">4 Core</div>
                    <input id="cpu-slider" type="range" min="0" max="4" step="1" value="0" class="custom-slider">
                </div>
            </div>
            ...
            <div class="custom-slider-section">
                ...
                <div class="flex items-center">
                    <div id="storage-value" class="custom-slider-value text-center" style="width: 75px;">120 GB</div>
                    <input id="storage-slider" type="range" min="0" max="4" step="1" value="0" class="custom-slider">
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-between items-center mb-4">
            <div class="text-2xl font-bold">
                <span class="flex items-center justify-center">
                    ...
                    <span id="total-price" class="h-[38px] gap-0 opacity-100 font-inter text-[32px] font-[700] leading-[38.4px] text-center text-[color:var(--Kazee-Primary-500,#4A6DCB)]">15.000</span>
        ...
        <p class="text-center text-[16px] font-normal leading-[23.2px] text-[#7C7C7C] font-inter">Price does not include tax.</p>
    </div>
</div>
