    ...
    <section class="section">
        <div class="container mx-auto px-4 py-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5 justify-items-center">
                <!-- Card 1 -->
                <div id="hover-container" class="flex flex-col items-center w-[183.33px] h-[266px] px-[20px] py-[30px] gap-[10px] border border-gray-200 shadow-sm rounded-[50px] bg-[#EBEFF9]">
                    <img id="litespeed-img" src="/assets/img/icons/section4 price/litespeed-logo-square.png" alt="litespeed" class="w-86 h-86 mb-4 transition-all duration-300 ease-in-out">
                ...
                <!-- Card 2 -->
                <div id="imunify-container" class="flex flex-col items-center w-[183.33px] h-[266px] px-[20px] py-[30px] gap-[10px] border border-gray-200 shadow-sm rounded-[50px] bg-[#EBEFF9]">
                    <img id="imunify-img" src="/assets/img/icons/section4 price/imunify360.png" alt="imunify360" class="w-86 h-86 mb-4 transition-all duration-300 ease-in-out">
                ...
                <!-- Card 3 -->
                <div id="cloudlinux-container" class="flex flex-col items-center w-[183.33px] h-[266px] px-[20px] py-[30px] gap-[10px] border border-gray-200 shadow-sm rounded-[50px] bg-[#EBEFF9]">
                    <img id="cloudlinux-img" src="/assets/img/icons/section4 price/cloudlinux 1.png" alt="cloud linux" class="w-86 h-86 mb-4 transition-all duration-300 ease-in-out">
                ...
                <!-- Card 4 -->
                <div id="cpanel-container" class="flex flex-col items-center w-[183.33px] h-[266px] px-[20px] py-[30px] gap-[10px] border border-gray-200 shadow-sm rounded-[50px] bg-[#EBEFF9]">
                    <img id="cpanel-img" src="/assets/img/icons/section4 price/cpanel.png" alt="cpanel" class="w-86 h-86 mb-4 transition-all duration-300 ease-in-out">
                ...
                <!-- Card 5 -->
                <div id="whm-container" class="flex flex-col items-center w-[183.33px] h-[266px] px-[20px] py-[30px] gap-[10px] border border-gray-200 shadow-sm rounded-[50px] bg-[#EBEFF9]">
                    <img id="whm-img" src="/assets/img/icons/section4 price/whm.png" alt="whm" class="w-86 h-86 mb-4 transition-all duration-300 ease-in-out">
                ...
                <!-- Card 6 -->
                <div id="softaculous-container" class="flex flex-col items-center w-[183.33px] h-[266px] px-[20px] py-[30px] gap-[10px] border border-gray-200 shadow-sm rounded-[50px] bg-[#EBEFF9]">
                    <img id="softaculous-img" src="/assets/img/icons/section4 price/softaculous.png" alt="softaculous" class="w-86 h-86 mb-4 transition-all duration-300 ease-in-out">
