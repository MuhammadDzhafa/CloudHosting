<div class="bg-white">
    <div class="w-full p-4 md:p-8 lg:p-[100px_200px] bg-[#FFFFFF]">
                ...
                <div class="p-4 md:p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="border-b border-[#DEDEDE] pb-6">
                            ...
                            <div class="flex space-x-1 md:space-x-1.5 lg:space-x-2 min-w-[300px] md:min-w-[600px] lg:min-w-full">
                                {!! str_repeat('
                                <div class="w-1 md:w-1.5 lg:w-2.5 h-6 md:h-7 lg:h-8 rounded-md bg-[#11CB9B] flex-shrink-0"></div>
                                ', 97) !!}
                            </div>
                        </div>
                        ...
                        <div class="border-b border-[#DEDEDE] pb-6">
                            ...
                            <div class="flex space-x-1 md:space-x-1.5 lg:space-x-2 min-w-[300px] md:min-w-[600px] lg:min-w-full">
                                ...
                                ', 96) !!}
                                {!! str_repeat('
                                <div class="w-1 md:w-1.5 lg:w-2.5 h-6 md:h-7 lg:h-8 rounded-md bg-red-500 flex-shrink-0"></div>
                                ', 1) !!}
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                <span class="text-[#4A6DCB] text-sm md:text-base lg:text-[16px] font-semibold leading-normal md:leading-[23.2px]">CPanel</span>
                                <span class="bg-[#11CB9B] text-[#EBEFF9] text-xs md:text-sm lg:text-[13px] font-medium leading-tight md:leading-[18.85px] px-[10px] py-[4px] rounded-full">Operational</span>
                            </div>
                            <div class="flex justify-between items-center mb-1">
                                <span class="text-[#000000] text-xs md:text-sm lg:text-[14px] font-medium leading-normal md:leading-[20.3px]">Uptime</span>
