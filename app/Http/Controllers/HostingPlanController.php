    ...
    public function update(Request $request, $id)
    {
        ...
        if (is_array($request->custom_main_spec)) {
            CustomMainSpec::updateOrCreate(
                ...
                [
                    'min_RAM' => $request->custom_main_spec['min_RAM'] ?? 0,
                    ...
                    'min_storage' => $request->custom_main_spec['min_storage'] ?? 0,
                    'max_storage' => $request->custom_main_spec['max_storage'] ?? null,
                    'step_storage' => $request->custom_main_spec['step_storage'] ?? null,
                    'price_storage' => $request->custom_main_spec['price_storage'] ?? null,
                    'min_CPU' => $request->custom_main_spec['min_CPU'] ?? 0,
                    'max_CPU' => $request->custom_main_spec['max_CPU'] ?? null,
                    'multiplier_CPU' => $request->custom_main_spec['multiplier_CPU'] ?? null,
